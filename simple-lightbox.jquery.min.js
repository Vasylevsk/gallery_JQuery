  ...
  function r(e, t) {
    if (!s[e]) {
      if (!n[e]) {
        ...
        if (l) return l(e, !0);
        throw (
          (((o = new Error("Cannot find module '" + e + "'")).code =
            "MODULE_NOT_FOUND"),
          o)
        );
      }
                  ...
                  this.addEventListener(
                    ...
                    function (t) {
                      if (i.isValidLink(t.currentTarget)) {
                        ...
                        (i.initialImageIndex = i.elements.indexOf(
                          t.currentTarget
                        )),
                        ...
                        "hide" === t
                          ? ((t = window.innerWidth) ||
                            ...
                            (document.body.clientWidth < t ||
                              ...
                              (document.body.dataset.originalPaddingRight = t),
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      s.addEventListener("load", function (t) {
                        ...
                        s.setAttribute(
                          "src",
                          this.relatedElements[i].getAttribute(
                      ...
                      t.setAttribute(
                        ...
                        t.addEventListener("load", function (t) {
                          ...
                          var e,
                            ...
                            i = t.target.width,
                            n = t.target.height;
                          (a.options.scaleImageToRatio || r < i || l < n) &&
                            ((i /= t = r / l < i / n ? i / r : n / l),
                            (n /= t)),
                            ...
                            (a.domNodes.image.style.height = n + "px"),
                            (a.domNodes.spinner.style.display = "none"),
                            ...
                            a.options.captions &&
                              ...
                              (o =
                                "data" === a.options.captionType
                                  ? e.dataset[a.options.captionsData]
                                  : "text" === a.options.captionType
                                  ? e.innerHTML
                                  : e.getAttribute(a.options.captionsData)),
                            a.options.loop
                    ...
                    value: function () {
                      ...
                      this.addEventListener(
                        ...
                        this.addEventListener(
                          ...
                          function (t) {
                            return (
                              !t.currentTarget.tagName.match(/button/i) ||
                              (t.preventDefault(),
                              (i.controlCoordinates.swipeDiff = 0),
                              void i.loadImage(
                        ...
                        this.options.scrollZoom &&
                          ...
                          this.addEventListener(
                            ...
                            function (t) {
                              if (
                                i.controlCoordinates.mousedown ||
                                i.isAnimating ||
                                i.isClosing ||
                                !i.isOpen
                              )
                                return !0;
                              0 == i.controlCoordinates.containerHeight &&
                                ((i.controlCoordinates.containerHeight =
                                  i.getDimensions(i.domNodes.image).height),
                                (i.controlCoordinates.containerWidth =
                                  i.getDimensions(i.domNodes.image).width),
                                (i.controlCoordinates.imgHeight =
                                  i.getDimensions(i.currentImage).height),
                                (i.controlCoordinates.imgWidth =
                                  i.getDimensions(i.currentImage).width),
                                (i.controlCoordinates.containerOffsetX =
                                  i.domNodes.image.offsetLeft),
                                (i.controlCoordinates.containerOffsetY =
                                  i.domNodes.image.offsetTop),
                                (i.controlCoordinates.initialOffsetX =
                                  parseFloat(
                                    i.currentImage.dataset.translateX
                                  )),
                                (i.controlCoordinates.initialOffsetY =
                                  parseFloat(
                                    i.currentImage.dataset.translateY
                                  ))),
                                t.preventDefault();
                              var e = t.delta || t.wheelDelta;
                              void 0 === e && (e = t.detail),
                                (e = Math.max(-1, Math.min(1, e))),
                                (o += e * i.options.scrollZoomFactor * o),
                                (o = Math.max(
                                  1,
                                  Math.min(i.options.maxZoom, o)
                                )),
                                (i.controlCoordinates.targetScale = o);
                              e =
                                document.documentElement.scrollTop ||
                                document.body.scrollTop;
                              (i.controlCoordinates.pinchOffsetX = t.pageX),
                                (i.controlCoordinates.pinchOffsetY =
                                  t.pageY - e || 0),
                                (i.controlCoordinates.limitOffsetX =
                                  (i.controlCoordinates.imgWidth *
                                    i.controlCoordinates.targetScale -
                                    i.controlCoordinates.containerWidth) /
                                  2),
                                (i.controlCoordinates.limitOffsetY =
                                  (i.controlCoordinates.imgHeight *
                                    i.controlCoordinates.targetScale -
                                    i.controlCoordinates.containerHeight) /
                                  2),
                                (i.controlCoordinates.scaleDifference =
                                  i.controlCoordinates.targetScale -
                                  i.controlCoordinates.initialScale),
                                (i.controlCoordinates.targetOffsetX =
                                  i.controlCoordinates.imgWidth *
                                    i.controlCoordinates.targetScale <=
                                  i.controlCoordinates.containerWidth
                                    ? 0
                                    : i.minMax(
                                        i.controlCoordinates.initialOffsetX -
                                          ((i.controlCoordinates.pinchOffsetX -
                                            ...
                                            i.controlCoordinates
                                              .scaleDifference,
                                        -1 * i.controlCoordinates.limitOffsetX,
                                        i.controlCoordinates.limitOffsetX
                                      )),
                                (i.controlCoordinates.targetOffsetY =
                                  i.controlCoordinates.imgHeight *
                                    i.controlCoordinates.targetScale <=
                                  i.controlCoordinates.containerHeight
                                    ? 0
                                    : i.minMax(
                                        i.controlCoordinates.initialOffsetY -
                                          ((i.controlCoordinates.pinchOffsetY -
                                            ...
                                            i.controlCoordinates
                                              .scaleDifference,
                                        -1 * i.controlCoordinates.limitOffsetY,
                                        i.controlCoordinates.limitOffsetY
                                      )),
                                i.zoomPanElement(
                                  i.controlCoordinates.targetOffsetX + "px",
                                  i.controlCoordinates.targetOffsetY + "px",
                                  i.controlCoordinates.targetScale
                                ),
                                1 < i.controlCoordinates.targetScale
                                  ? ((i.controlCoordinates.zoomed = !0),
                                    (!i.domNodes.caption.style.opacity ||
                                      0 < i.domNodes.caption.style.opacity) &&
                                      "none" !==
                                        i.domNodes.caption.style.display &&
                                      i.fadeOut(
                                        i.domNodes.caption,
                                        i.options.fadeSpeed
                                      ))
                                  : (1 === i.controlCoordinates.initialScale &&
                                      ((i.controlCoordinates.zoomed = !1),
                                      "none" ===
                                        i.domNodes.caption.style.display &&
                                        i.fadeIn(
                                          i.domNodes.caption,
                                    ...
                                    (i.controlCoordinates.initialPinchDistance =
                                      null),
                                    (i.controlCoordinates.capture = !1)),
                                (i.controlCoordinates.initialPinchDistance =
                                  i.controlCoordinates.targetPinchDistance),
                                (i.controlCoordinates.initialScale =
                                  i.controlCoordinates.targetScale),
                                (i.controlCoordinates.initialOffsetX =
                                  i.controlCoordinates.targetOffsetX),
                        ...
                        this.addEventListener(
                          ...
                          function (t) {
                            ...
                            if ("mousedown" === t.type)
                              t.preventDefault(),
                                (i.controlCoordinates.initialPointerOffsetX =
                                  t.clientX),
                                (i.controlCoordinates.initialPointerOffsetY =
                                  t.clientY),
                                (i.controlCoordinates.containerHeight =
                                  i.getDimensions(i.domNodes.image).height),
                                (i.controlCoordinates.containerWidth =
                              ...
                              if (
                                ((i.controlCoordinates.touchCount =
                                  t.touches.length),
                                (i.controlCoordinates.initialPointerOffsetX =
                                  t.touches[0].clientX),
                                (i.controlCoordinates.initialPointerOffsetY =
                                ...
                                (i.controlCoordinates.containerOffsetY =
                                  i.domNodes.image.offsetTop),
                                1 === i.controlCoordinates.touchCount)
                              ) {
                                if (i.controlCoordinates.doubleTapped)
                                  return (
                                    i.currentImage.classList.add(
                                      "sl-transition"
                                    ),
                                    i.controlCoordinates.zoomed
                                      ? ((i.controlCoordinates.initialScale = 1),
                                        i.setZoomData(
                                          i.controlCoordinates.initialScale,
                                          0,
                                          0
                                    ...
                                    setTimeout(function () {
                                      i.currentImage &&
                                        i.currentImage.classList.remove(
                                          "sl-transition"
                                        );
                                    }, 200),
                                    !1
                                  );
                                (i.controlCoordinates.doubleTapped = !0),
                                  setTimeout(function () {
                                ...
                                2 === i.controlCoordinates.touchCount &&
                                  ((i.controlCoordinates.initialPointerOffsetX2 =
                                    t.touches[1].clientX),
                                  (i.controlCoordinates.initialPointerOffsetY2 =
                                    t.touches[1].clientY),
                                  (i.controlCoordinates.initialOffsetX =
                                    parseFloat(
                                      i.currentImage.dataset.translateX
                            ...
                            return (
                              !!i.controlCoordinates.mousedown ||
                              (i.transitionCapable &&
                                (i.controlCoordinates.imageLeft = parseInt(
                                  i.domNodes.image.style.left,
                                  10
                                )),
                              (i.controlCoordinates.mousedown = !0),
                              (i.controlCoordinates.swipeDiff = 0),
                              (i.controlCoordinates.swipeYDiff = 0),
                              (i.controlCoordinates.swipeStart =
                                t.pageX || t.touches[0].pageX),
                              (i.controlCoordinates.swipeYStart =
                          ...
                          function (t) {
                            ...
                            if ("touchmove" === t.type) {
                              if (!1 === i.controlCoordinates.capture)
                                return !1;
                              (i.controlCoordinates.pointerOffsetX =
                                t.touches[0].clientX),
                                (i.controlCoordinates.pointerOffsetY =
                                  t.touches[0].clientY),
                                (i.controlCoordinates.touchCount =
                                  t.touches.length),
                                i.controlCoordinates.touchmoveCount++,
                                1 < i.controlCoordinates.touchCount
                                  ? ((i.controlCoordinates.pointerOffsetX2 =
                                      t.touches[1].clientX),
                            ...
                            if (
                              ...
                              if (
                                (t.preventDefault(),
                                !1 === i.controlCoordinates.capture)
                              )
                                return !1;
                              (i.controlCoordinates.pointerOffsetX = t.clientX),
                                (i.controlCoordinates.pointerOffsetY =
                                  t.clientY),
                                (i.controlCoordinates.targetScale =
                                  i.controlCoordinates.initialScale),
                                ...
                                Math.abs(i.controlCoordinates.targetOffsetX) ===
                                  Math.abs(i.controlCoordinates.limitOffsetX) &&
                                  ((i.controlCoordinates.initialOffsetX =
                                    i.controlCoordinates.targetOffsetX),
                                  (i.controlCoordinates.initialPointerOffsetX =
                                    i.controlCoordinates.pointerOffsetX)),
                                Math.abs(i.controlCoordinates.targetOffsetY) ===
                                  Math.abs(i.controlCoordinates.limitOffsetY) &&
                                  ((i.controlCoordinates.initialOffsetY =
                                    i.controlCoordinates.targetOffsetY),
                                  (i.controlCoordinates.initialPointerOffsetY =
                                    i.controlCoordinates.pointerOffsetY)),
                            ...
                            i.controlCoordinates.zoomed ||
                              ((i.controlCoordinates.swipeEnd =
                                t.pageX || t.touches[0].pageX),
                              (i.controlCoordinates.swipeYEnd =
                                t.pageY || t.touches[0].pageY),
                              (i.controlCoordinates.swipeDiff =
                                i.controlCoordinates.swipeStart -
                                i.controlCoordinates.swipeEnd),
                              (i.controlCoordinates.swipeYDiff =
                                i.controlCoordinates.swipeYStart -
                                i.controlCoordinates.swipeYEnd),
                              i.options.animationSlide &&
                                i.slide(
                                  0,
                                  -i.controlCoordinates.swipeDiff + "px"
                                ));
                          }
                        ),
                        this.addEventListener(
                          ...
                          function (t) {
                            i.isTouchDevice &&
                              ...
                              ((i.controlCoordinates.touchCount =
                                t.touches.length),
                              0 === i.controlCoordinates.touchCount
                                ? (i.currentImage &&
                                    i.setZoomData(
                                      i.controlCoordinates.initialScale,
                                      i.controlCoordinates.targetOffsetX,
                                ...
                                : 1 < i.controlCoordinates.touchCount &&
                                  (i.controlCoordinates.initialPinchDistance =
                                    null)),
                              i.controlCoordinates.mousedown &&
                                ((t = !(i.controlCoordinates.mousedown = !1)),
                                i.options.loop ||
                                  (0 === i.currentImageIndex &&
                                    i.controlCoordinates.swipeDiff < 0 &&
                                    (t = !1),
                                  i.currentImageIndex >=
                                    i.relatedElements.length - 1 &&
                                    0 < i.controlCoordinates.swipeDiff &&
                                    (t = !1)),
                                Math.abs(i.controlCoordinates.swipeDiff) >
                                  i.options.swipeTolerance && t
                                  ? i.loadImage(
                                      0 < i.controlCoordinates.swipeDiff
                                        ? 1
                                        : -1
                                  ...
                                  : i.options.animationSlide &&
                                    i.slide(
                                      i.options.animationSpeed / 1e3,
                                      "0px"
                                    ),
                                i.options.swipeClose &&
                                  50 <
                                    Math.abs(i.controlCoordinates.swipeYDiff) &&
                                  Math.abs(i.controlCoordinates.swipeDiff) <
                                    i.options.swipeTolerance &&
                                  i.close());
                          }
                        ),
                        this.addEventListener(
                          ...
                          function (t) {
                            if (!i.isTouchDevice)
                              return (
                                ...
                                (i.controlCoordinates.containerOffsetY =
                                  i.domNodes.image.offsetTop),
                                i.currentImage.classList.add("sl-transition"),
                                i.controlCoordinates.zoomed
                                  ? ((i.controlCoordinates.initialScale = 1),
                                    i.setZoomData(
                                      i.controlCoordinates.initialScale,
                                ...
                                setTimeout(function () {
                                  i.currentImage &&
                                    ...
                                    (i.currentImage.style[
                                      i.transitionPrefix + "transform-origin"
                                    ] = null));
                                }, 200),
                                !(i.controlCoordinates.capture = !0)
                              );
